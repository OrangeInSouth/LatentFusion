...
anchor_prex = "llama2-13b_mistral-7b_200000anchors_seed1"
anchor_path = f"{anchor_path}/{anchor_prex}.pt"
models = ["llama2-13b", "mistral-7b"]
layer_pair = [40, 32]

output_path = f"{anchor_path}/{anchor_prex}_layer{'-'.join([str(i) for i in layer_pair])}.pt"
