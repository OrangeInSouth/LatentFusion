...
if __name__ == "__main__":
    ...
    anchor_embeddings_path = f"/share/home/fengxiaocheng/ychuang/LatentFusion/experiments/anchor_embeddings_v3/llama2-13b_mistral-7b_{anchor_num}anchors_seed{seed}_layer{'-'.join(layer_pair)}.pt"
    save_dir = "/share/home/fengxiaocheng/ychuang/LatentFusion/experiments/embedding_projection"
    output_path = f"{save_dir}/EstimationEmbeddingProjection_{anchor_num}anchors-v3_seed{seed}_layer{'-'.join(layer_pair)}.pt"
